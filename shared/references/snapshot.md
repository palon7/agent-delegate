...
- Git's `core.fileMode` and `core.symlinks` settings are respected, including executable files and links checked out as regular files on Windows. Windows `--include` paths may use either slash style.
