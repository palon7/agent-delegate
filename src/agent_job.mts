...
const USAGE =
  "agent_job.mjs --agent opencode|codex --job-dir PATH [--state-dir PATH] --cwd PATH [--profile PATH] --mode implement|review --thread UUID [--session ID] [--model MODEL] [--pass-env NAME] [--srt PATH] [--executable PATH] [--codex PATH]";
